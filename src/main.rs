...
async fn main() {
    ...
    let flutterwave = Flutterwave::new().await;
    ...
    Router::new()
        ...
        .nest(
            ...
            Router::new()
                ...
                .route("/get-payment-link", post(api::create_payment_link))
                .route(
                    "/flutterwave-callback",
                    get(api::handle_flutterwave_callback),
                )
                .layer(axum::middleware::from_fn(
                    middleware::api_cache_control_headers,
                )),
        )
